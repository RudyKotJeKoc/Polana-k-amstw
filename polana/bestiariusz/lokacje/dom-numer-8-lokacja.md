...
**Dwa kręgi nieskończoności:**
- Klątwa bez końca – pętla, z której nie ma wyjścia
- Dwa synowie utraceni (metafora Wiedźmy – dwóch synów straconych w wyniku jej obsesji)
...
#### Warsztat
- Miejsce ucieczki Wilka po eskalacji konfliktu
- Spanie na starych drzwiach rzuconych na betonowej podłodze
- Tracący powietrze materac – budzenie w zimnie każdej nocy
- Pianka montażowa w szczelinach – desperacka próba odizolowania się od wzroku Wiedźmy
- Symbol: schronienie, które jest więzieniem-z-wyboru

#### Zaspawana toaleta
- Zewnętrzna toaleta, zamek zaspawany przez Wilka
- Akt desperacji, fizyczne zamknięcie prawdy
- **Symbol:** "Nagrobek dla prawdy"
- Myśl Wilka: *"Niech zgnije w środku, skoro nie może wyjść na zewnątrz. To nie zamek. To nagrobek dla prawdy."*

### Atmosfera i duchy miejsca

**Gdy Wiedźma zostaje w Dziupli sama, miejsce zaczyna ją odbijać:**
- zimno, które nie pochodzi z temperatury, tylko z pustki
- echo kroków, które nie mają dokąd iść
- brak śmiechu, którego nigdy tu nie było
- brak mruczenia kotów – duchy progu odeszły
