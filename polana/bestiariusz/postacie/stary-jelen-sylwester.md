...
slug: "stary-jelen-sylwester"
kategoria: "postac"
archetyp: "Tragiczna Marionetka / Pokémon z Czerwoną Czapką"
powiazane_symbole:
  - czerwona-czapka
  - pelnomocnictwo
powiazane_motywy:
...
## II. MOTYWACJA I STAN PSYCHICZNY

**Główna motywacja:**
Brak samodzielnej woli. Po przebytym wylewie (~2019), z I grupą inwalidzką i deficytami poznawczymi, stał się całkowicie zależny od żony.

**Stan zdrowia:**
- Wylew mózgu (przed 2019)
- Operacja tętniaka
- I grupa inwalidzka
- Deficyty poznawcze:
...
> — Sylwester Adamski (nie pamiętał własnego wieku)
...
└── figurant → PUSZCZYK, SZLEMIERZ (system)
    └── jego podpis akceptowany bezkrytycznie
```
...
- **Bociany (rodzeństwo Dariusza):** Dzieci, które nie bronią ojca przed instrumentalizacją. Wspierają narrację matki.
...
> **Data:** 19.07.2021 (2 dni po Niebieskiej Karcie!)
>
> **Lokacja:** Notariusz
>
...
### Scena 2: Diamentowa sprzeczność (3.08 vs 6.08.2021)
...
> **Lokacja:** Sąd cywilny
>
> Sylwester na rozprawie:
> - Nie pamięta własnego wieku
> - Myli daty, wydarzenia
> - Gdy jest zapytany o szczegóły, odpowiada: *"Jej zeznania są moimi zeznaniami."*
>
> **Znaczenie:** Całkowita utrata autonomii. Pokémon nie ma własnego zdania - tylko powtarza polecenia trenera.

### Scena 4: Incydent z 21.05.2021 (Odwrócony triaż)
...
>
> **Znaczenie:** Instrumentalizacja nawet w sytuacji zagrożenia zdrowia.
...
- Czerwień = wylew mózgu (krew)
- Symbol przejętej władzy
- Autorytet formalny bez rzeczywistej władzy
- "Papesmerf" = Papa (ojciec) + Smerf (mały, niegroźny)
...
**Funkcja narracyjna:**
- Narzędzie Wiedźmy
- Symbol instrumentalizacji słabości
- Ostrzeżenie: jak autorytet może być zawłaszczony
...
❌ **Porażka faktyczna:**
- Emocjonalnie zgasły, milczący cień
- Wykorzystany przeciwko własnemu synowi
- Relacja z Dariuszem zniszczona
- Bomba zegarowa: prawny obowiązek zwrotu nakładów Wilka (160-255 tys. zł) ciąży na nim
...
**Krajna Gothic:**
- Papesmerf nie jest złem - jest narzędziem zła
- Jego tragedia jest cichsza niż Wilka, ale głębsza
- Symbol: jak system prawny akceptuje bezkrytycznie podpisy osób niepełnosprawnych

**Uwagi:**
- Unikać pokazywania jako "współwinnego" - jest ofiarą
- Jego stan zdrowia nie odbiera mu człowieczeństwa
- Diamentowa sprzeczność 3.08 vs 6.08 to kluczowy dowód manipulacji
- Finał musi być smutny - nie ma odkupienia dla Papesmerfa

**Powiązane dokumenty:**
- kontekst_1.md (analiza postaci drugoplanowych)
- APPENDIX_B: Czerwona Czapka (artefakt)
- Rozdział 9 w BASN_POLANA_KLAMSTW.md (Stary Jeleń - Marionetka)
