...
**Pokéball jako narzędzie "schwytania"**
...
Zjawisko Pokéballa Wiedźmy objawia się w dwóch próbach "złapania":

**PRÓBA 1: Papesmerf (Sylwester) — ZŁAPANY ✓**

1. **~2019: Wylew mózgu Sylwestra**
   - Nagłe wydarzenie, które zmienia wszystko
   - Z dumnego Jelenia → krucha istota, zależna
   - **Cel staje się podatny**
...
1. **Próby złapania:**
   ...
   - Próba podporządkowania przez Kalendarz Krzywd
...
**Mechanizm zjawiska (fazy):**

1. **Identyfikacja celu podatnego:**
   - Osoba schorowana, zależna, bezradna
   - Sylwester po wylewie = idealny cel

2. **Rzucenie Pokéballa (narzędzie kontroli):**
   - Pełnomocnictwo, zależność finansowa, izolacja
   - Prawne lub psychologiczne narzędzie przejęcia władzy

3. **"Złapanie" (przejęcie kontroli):**
   - Od tego momentu manipulator mówi głosem ofiary
   - Ofiara traci autonomię, staje się Pokémonem

4. **Kontrola (trener → Pokémon):**
   - Ofiara wykonuje polecenia manipulatora
   - Nie ma własnej woli, tylko wolę trenera
   - *"Jej zeznania są moimi zeznaniami"*

**Inne przykłady zjawiska (poza Polana Kłamstw):**
- Każda sytuacja, gdzie manipulator wykorzystuje słabość ofiary do przejęcia kontroli
- Pełnomocnictwa nadużywane przez opiekunów
- Izolacja osób starszych, chorych, zależnych
- Wykorzystywanie zależności finansowej/emocjonalnej

## Konsekwencje dla Polany

**Dla Papesmerfa (Sylwestra):**
- Utrata autonomii, tożsamości prawnej
- Stał się narzędziem w wojnie Wiedźmy
...
**Dla Polany Kłamstw:**
- Zjawisko pokazuje, jak słabość może być wykorzystana
- System prawny (pełnomocnictwo) może być narzędziem manipulacji
- Autorytet bez woli to najsmutniejsza marionetka
...
- **Mechanizm "złapania"** — przejęcie kontroli nad osobą podatną
- **Narzędzie kontroli** — pełnomocnictwo, zależność, izolacja
- **Cel podatny** — schorowany, zależny, bezradny
...
`#zjawisko` `#psychologia` `#kontrola` `#manipulacja` `#pokeball` `#pełnomocnictwo` `#zależność` `#trener-pokemon`
