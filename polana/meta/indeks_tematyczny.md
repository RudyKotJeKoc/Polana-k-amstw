# INDEKS TEMATYCZNY – POLANA KŁAMSTW

## Przewodnik po Materiałach

Ten indeks pomaga w nawigacji po wszystkich dostępnych materiałach projektu "Polana Kłamstw" według tematów, postaci, dat i kluczowych pojęć.
...
- Decyzja o rezygnacji z apelacji
...
- Diamentowa sprzeczność (3 vs 6 sierpnia)
- Rola marionetki
- "Jej zeznania są moimi zeznaniami"
- Odwrócony triaż (21.05.2021)
...
- Związek z Dariuszem (14.02.2021)
...
- Kontakt ze stroną przeciwną
- WDS Legal - konflikt interesów
- "Tekturka" - zabezpieczenie własnych interesów
- Koronny dowód procesowy
...
**Kluczowe tematy:**
- Brak inicjatywy
- Brak zgłoszenia Domka jako świadka
- Brak odpowiedzi na pozew
- Ochrona kolegi z kancelarii
- Bierna kolaboracja
...
- Bezkrytyczne przyjęcie Kalendarza
- Ignorowanie sprzeczności
- "Sąd papieru"

### Sojusznicy i Bierni Obserwatorzy
...
- Zeznania "ze słyszenia"
- Sprawa KRUS (18,000 zł kary)
- Wzmacnianie narracji
...
**Kluczowe tematy:**
- Artur, Monika, Michał
- Bezkrytyczne powielanie wersji matki
- Bierność i lojalność
- Izolacja Dariusza
...
- Kocioł Krzywd nigdy nie stygnie
- Czekanie na iskrę
...
- Wypowiedzenie wojny
- Start prowadzenia Kalendarza Wiedźmy
...
- Szerokie pełnomocnictwo od Sylwestra
- Przejęcie tożsamości prawnej
...
- Wymuszenie przyznania się
- Fałszywa obietnica Domka
- "Tekturka" - zabezpieczenie
- Wyrok karny = koronny dowód
...
**Kluczowe elementy:**
- Oddalenie wniosków dowodowych
- Brak przesłuchania Domka
- Brak badania psychiatrycznego Sylwestra
- Ignorowanie sprzeczności
- Błąd prawny (służebność ≠ dożywocie)
- Bezkrytyczne przyjęcie Kalendarza i wyroku karnego

**29.08.2025 - Wyrok**
- Anatomia - Sekcja II.4

**Kluczowe elementy:**
- Nakaz zwrotu nieruchomości
- Obciążenie kosztami procesu
- Egzekucja oparta na wadliwych dowodach
...
**Kluczowe elementy:**
- Odejście z Polany Kłamstw
- Nowe życie z Julią
- Przegrana materialna = zwycięstwo duchowe
- Wolność
...
**Gdzie szukać:**
- Prowokacja → oskarżenie o agresję
- Ofiara → sprawca
- Milczenie → przemoc psychiczna
...
- Wymuszenie przyznania się
- "Koronny dowód"
- Niemożność merytorycznej obrony

### D. UNIWERSALNE TEMATY
...
#### Paradoks Zwycięstwa/Porażki
- Kronika - Rozdział 11, 12, Epilog
- Anatomia - Sekcja III
- Przewodnik - Sekcja 5.0
...
- Kronika - Rozdział 11
- Anatomia - Sekcja II.5
- POLANA_KLAMSTW_KOMPLETNA_KRONIKA - Sekcja 5.5

**Gdzie szukać:**
- "Opłata za wolność"
- Analiza decyzji Dariusza
- Emigracja jako wyzwolenie
- Prawdziwa wartość

---

## 4. INDEKS CYTATÓW I KLUCZOWYCH FRAZ

### "Echo jest silniejsze niż głos"
- Kronika - Prolog
- Anatomia - Wprowadzenie
- Przewodnik - Sekcja 2.1
- README - motto
...
## 5. INDEKS PRAWNY I PROCEDURALNY
...
## 6. JAK UŻYWAĆ TEGO INDEKSU

### Dla Analizy Tematycznej:
1. Wybierz temat z sekcji 3
2. Zobacz wszystkie wymienione lokalizacje
3. Przeczytaj w kolejności: Przewodnik → Kronika → Anatomia → Konteksty

### Dla Analizy Postaci:
1. Wybierz postać z sekcji 1
2. Start: Przewodnik (profil archetypiczny)
3. Kontynuuj: Kronika (narracja)
4. Pogłębiaj: konteksty (dowody, szczegóły)

### Dla Chronologii:
1. Zobacz sekcję 2
2. Przeczytaj wydarzenia w porządku czasowym
3. Dla każdego wydarzenia sprawdź wszystkie wymienione źródła
...
*Ten indeks jest żywym dokumentem i będzie aktualizowany wraz z rozwojem projektu.*
